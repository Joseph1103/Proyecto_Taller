...
def play_laser():
    pygame.mixer.music.load("C:/Users/50685/OneDrive/Escritorio/Sprites para el juego/assets_laser5.ogg")
...
class Ventana():
    ...
    def PantallaPrincipal(self):
        ...
        bg = PhotoImage(file="C:/Users/50685/OneDrive/Imágenes/fondo.gif")
...
# Nivel 1
    def first_level(self):
        self.canvas = Canvas(self.ventana, width=350, height=450, highlightbackground="White")
        self.canvas.place(x=-5, y=0)
        bg = PhotoImage(file="C:/Users/50685/OneDrive/Imágenes/partida.png")
        self.canvas.create_image(0, 0, image=bg, anchor="nw")
...
# Nave
        self.nave_player = PhotoImage(file="C:/Users/50685/OneDrive/Escritorio/Pixel Spaceships/nav.png")
        self.nave = self.canvas.create_image(142, 360, anchor=NW, image=self.nave_player)

# Boss 1
        self.boss_l1 = PhotoImage(file="C:/Users/50685/OneDrive/Escritorio/Pixel Spaceships/boss1.png")
...
# Mecanica de disparo
 ...
 # Movimiento de la nave y disparo
        ...
        def space(event):
            ...
            bullet_player = PhotoImage(file="C:/Users/50685/OneDrive/Escritorio/Sprites para el juego/laser1.png")
...
# boss_2
        self.boss_2 = PhotoImage(file="C:/Users/50685/OneDrive/Escritorio/Pixel Spaceships/boss2.png")
...
# tercer nivel
    ...
    def third_level(self):
        ...
        #boos_3
        self.boss3_l3 = PhotoImage(file="C:/Users/50685/OneDrive/Escritorio/Pixel Spaceships/boss3.png")
